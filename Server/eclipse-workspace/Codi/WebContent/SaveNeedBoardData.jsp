...
try {
	...
	try {
		...
		sql = "SELECT id from NEEDBOARD where rownum <= 1 order by id desc";
	    ...
	    sql2 = "INSERT INTO NEEDBOARD VALUES(?,?,?,?,(TO_DATE(?,'YYYY-MM-DD HH24:MI:SS')),?,?,?)";
	    ...
	    pstmt2.setString(7, arraylist[2]);//board이름
